...
public class BottomViewKind3 extends BaseBottomView implements IViewStateChange {
	...
	public BottomViewKind3(Context context) {
		super(context);
	}
	...
	private void initView() {
		List<BannerItemBean> bannerDatas = getData(CardViewPagerActivity.mData3);
		...
		mBottomAdapter = new BottomAdapter(getContext(), getBottomData(2));
	...
	private void loadData() {
		mBannerAdapter.refreshData(getData(CardViewPagerActivity.mData3));
		mBottomAdapter.refreshData(getBottomData(2));
	}
