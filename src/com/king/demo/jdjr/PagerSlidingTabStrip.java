...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int mIndicatorWidthOffset;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        mIndicatorWidthOffset = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, mIndicatorWidthOffset, dm);
        ...
        mTabMargin = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, mTabMargin, dm);
        ...
        mIndicatorWidthOffset = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsIndicatorWidthOffset, mIndicatorWidthOffset);
        ...
        mTabMargin = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsTabMarginLeftRight, mTabMargin);
    ...
    private void updateTabStyles() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            ...
            if(mTabMargin > 0) { // 增加Margin属性
            	LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT); 
            	lp.gravity = Gravity.CENTER;
            	lp.leftMargin = mTabMargin;
            	lp.rightMargin = mTabMargin;
            	lp.topMargin = v.getPaddingTop();
            	lp.bottomMargin = v.getPaddingBottom();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorHeight > 0) {
            ...
            Pair<Float, Float> lines = getIndicatorCoordinates();
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            	canvas.drawRoundRect(lines.first + mPaddingLeft + mIndicatorWidthOffset, height - mIndicatorHeight, lines.second + mPaddingLeft - mIndicatorWidthOffset, height, 5, 5, mRectPaint);
            } else { 
            	RectF rf = new RectF(lines.first + mPaddingLeft + mIndicatorWidthOffset, height - mIndicatorHeight, lines.second + mPaddingLeft - mIndicatorWidthOffset, height);
            	canvas.drawRoundRect(rf, 5, 5, mRectPaint);
            }
        }
    }
    ...
    public void updateSelection(int x, int y) {
    	...
    	for (int i = 0; i < mTabCount; ++i) {
            ...
            RectF rect = calcViewScreenLocation(tv);
