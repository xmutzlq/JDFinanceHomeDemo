...
public class BottomViewKind2 extends BaseBottomView implements IViewStateChange {
	...
	public BottomViewKind2(Context context) {
		super(context);
	}
	...
	private void initView() {
		List<BannerItemBean> bannerDatas = getData(CardViewPagerActivity.mData2);
		...
		mBottomAdapter = new BottomAdapter(getContext(), getBottomData(1));
	...
	private void loadData() {
		mBannerAdapter.refreshData(getData(CardViewPagerActivity.mData2));
		mBottomAdapter.refreshData(getBottomData(1));
	}
